...
class EmpleadosControllerTest < ActionController::TestCase
  ...
  test "should create empleado" do
    assert_difference('Empleado.count') do
      post :create, empleado: { Direccion: @empleado.Direccion, Nombre: @empleado.Nombre, fechaEntrada: @empleado.fechaEntrada }
    end
  ...
  test "should update empleado" do
    patch :update, id: @empleado, empleado: { Direccion: @empleado.Direccion, Nombre: @empleado.Nombre, fechaEntrada: @empleado.fechaEntrada }
    assert_redirected_to empleado_path(assigns(:empleado))
  end
