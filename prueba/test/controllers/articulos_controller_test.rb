...
class ArticulosControllerTest < ActionController::TestCase
  ...
  test "should create articulo" do
    assert_difference('Articulo.count') do
      post :create, articulo: { descripcion: @articulo.descripcion, nombre: @articulo.nombre, precio: @articulo.precio, stock: @articulo.stock }
    end
  ...
  test "should update articulo" do
    patch :update, id: @articulo, articulo: { descripcion: @articulo.descripcion, nombre: @articulo.nombre, precio: @articulo.precio, stock: @articulo.stock }
    assert_redirected_to articulo_path(assigns(:articulo))
  end
